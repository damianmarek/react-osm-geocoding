...
export const ReactOsmGeocoding = ({
  placeholder = "Enter address",
  debounce = 1000,
  iconUrl = "https://cdn2.iconfinder.com/data/icons/ios-7-icons/50/search-512.png",
  callback,
  countrycodes = "pl",
  acceptLanguage = "pl",
  viewbox = "",
  ...
  return (
    <div className={styles.reactOsmGeocoding} ref={mainContainerRef}>
      <input
        type="text"
        name="geocoding"
        id="geocoding"
